...
<p class="share-button twitter lsf" style="<?php if($count_blind_twitter){echo "line-height:50px; font-size:2em;";} ?>">twitter</p>
</a>
...
<p class="share-button fb lsf" style="<?php if($count_blind_fb){echo "line-height:50px; font-size:2em;";} ?>">facebook</p>
</a>
...
?>
<div class="share-count-button">
<a class="no-deco" target="_blank" href="https://b.hatena.ne.jp/add?mode=confirm&url=<?php echo $url_encoded; ?>&title=<?php echo $title_encoded; ?>">
<p class="share-button hatebu lsf" style="<?php if($count_blind_hatebu){echo "line-height:50px; font-size:2em;";} ?>">hatenabookmark</p>
</a>
...
?>
<div class="share-count-button">
<a class="no-deco" target="_blank" href="https://getpocket.com/edit?url=<?php echo $url_encoded; ?>&title=<?php echo $title_encoded; ?>">
<p class="share-button pocket" style="<?php if($count_blind_pocket){ echo "line-height:50px; font-size:2.1em;"; } ?>"><span class="icon-pocket"></span></p>
</a>
...
<div class="share-count-button">
<a class="no-deco" target="_blank" href="https://line.me/R/msg/text/?<?php echo $title_encoded." "; ?><?php echo $url_encoded; ?>">
